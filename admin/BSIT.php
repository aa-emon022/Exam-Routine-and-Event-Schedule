...
<h2><font color="white">BBA Schedule List</font></h2>
...
<br>
  ...
  <ul>
    ...
    <li class="active"><a href="BSIT.php"><font color="white">BBA</a></font></li>
   <li><a href="AB.php"><font color="white">Law</font></a></li>
    <li><a href="BEED.php"><font color="white">Pharmacy</font></a></li>
    <li><a href="BSED.php"><font color="white">JC&MS</font></a></li>
    <li><a href="GS.php"><font color="white">GOther Dept.</font></a></li>
  </ul>
</div>
...
<div class="table_background">
		...
		<table  id="demoTable"  class="table table-striped table-bordered table-condensed">
			...
			<tbody>
<?php $result=mysqli_query($conn,"select * from schedule where type='' and CYS like '%BBA%' order by schedule_id DESC")or die(mysqli_error());
