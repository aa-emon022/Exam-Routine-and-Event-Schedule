...
<ul class="nav nav-tabs nav-stacked">
  ...
  <li><a href="department.php">Faculties</a></li>
  <li class="active"><a href="shool_year.php"><font color="white">Section</font></a></li>

</ul>
</div>
<div class="right-nav-content">
<h2><font color="white">Faculties List</font></h2>
	<a class="btn btn-primary" href="">  <i class="icon-plus-sign icon-large"></i>&nbsp;Add Faculties</a>
	<hr>
