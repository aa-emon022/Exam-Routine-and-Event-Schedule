...
<h2><font color="white">Other Dept. Exam Schedule List</font></h2>
	<a class="btn btn-primary"  href="add_exam.php">  <i class="icon-plus-sign icon-large"></i>&nbsp;Add Exam Schedule</a>
	<hr>
	<div class="pagination">
  <ul>
    <li><a href="exam_schedule.php"><font color="white">All DEPT.</font></a></li>
    <li>
      <a href="exam_BSIS.php"><font color="white">CSE</font></a>
    </li>
    <li><a href="exam_BSCE.php"><font color="white">EEE</font></a></li>
    <li><a href="exam_BSHRM.php"><font color="white">English</font></a></li>
    <li><a href="exam_BSIT.php"><font color="white">BBA</a></font></li>
    <li><a href="exam_AB.php"><font color="white">Law</font></a></li>
    <li><a href="exam_BEED.php"><font color="white">Pharmacy</font></a></li>
    <li><a href="exam_BSED.php"><font color="white">JC&MS</font></a></li>
    <li class="active"><a href="exam_GS.php"><font color="white">Other Dept.</font></a></li>
  </ul>
</div>
