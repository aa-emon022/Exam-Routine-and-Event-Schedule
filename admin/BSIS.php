...
<h2><font color="white">CSE Schedule List</font></h2>
...
<div class="table_background">
		...
		<table  id="demoTable"  class="table table-striped table-bordered table-condensed">
			...
			<tbody>
<?php $result=mysqli_query($conn,"select * from schedule where type='' and CYS like '%CSE%' order by schedule_id DESC")or die(mysqli_error());
