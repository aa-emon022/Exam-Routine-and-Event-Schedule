...
<h2><font color="white">EEE Schedule List</font></h2>
...
<br>
  ...
  <ul>
    ...
    <li  class="active"><a href="BSCE.php"><font color="white">EEE</font></a></li>
    <li><a href="BSHRM.php"><font color="white">English</font></a></li>
    <li><a href="BSIT.php"><font color="white">BSIT</a></font></li>
       <li><a href="AB.php"><font color="white">BBA</font></a></li>
    <li><a href="BEED.php"><font color="white">Law</font></a></li>
...
<div class="table_background">
		...
		<table  id="demoTable"  class="table table-striped table-bordered table-condensed">
			...
			<tbody>
<?php $result=mysqli_query($conn,"select * from schedule where type='' and CYS like '%EEE%' order by schedule_id DESC")or die(mysqli_error());
