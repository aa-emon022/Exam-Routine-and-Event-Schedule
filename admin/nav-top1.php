	...
	<div class="container">
		...
		<a class="branded">
		<img src="img/vu.jpg" width="100" height="90">
 	</a> 
	<a class="brand">
	 <h1>VU Scheduling System</h1>
	 <div class="chmsc_nav"><font size="5" style="Bookman Old Style" color="white">Varendra University</font></div>
 	</a>
<div class="time_top">	
<font color="orange">
  <?php
