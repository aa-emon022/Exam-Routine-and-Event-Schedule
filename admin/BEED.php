...
<h2><font color="white">pharmacy Schedule List</font></h2>
...
<br>
  <ul>
    ...
    <li>
      <a data-toggle="modal" href="#CYS"><font color="white"><i class="icon-search icon-large"></i>Department</font></a>
    </li>
	 <li>
	...
	<div class="pagination">
  <ul>
    <li><a href="schedule.php"><font color="white">All DEPT.</font></a></li>
    <li>
      <a href="BSIS.php"><font color="white">CSE</font></a>
    </li>
    <li><a href="BSCE.php"><font color="white">EEE</font></a></li>
    <li><a href="BSHRM.php"><font color="white">English</font></a></li>
    <li><a href="BSIT.php"><font color="white">BBA</a></font></li>
    <li><a href="AB.php"><font color="white">Law</font></a></li>
    <li  class="active"><a href="BEED.php"><font color="white">Pharmacy</font></a></li>
    <li><a href="BSED.php"><font color="white">JC&MS </font></a></li>
    <li><a href="GS.php"><font color="white">Other Dept.</font></a></li>
  </ul>
</div>
...
<div class="table_background">
		...
		<table  id="demoTable"  class="table table-striped table-bordered table-condensed">
			...
			<tbody>
<?php $result=mysqli_query($conn,"select * from schedule where type='' and CYS like '%Pharmacy%' order by schedule_id DESC")or die(mysqli_error());
...
<option><?php echo $sy_row['sy']; ?></option>
 <?php } ?>
  ...
  <h2>Search Department Schedule</h2>
Please select data on each field to filter.
<hr>
